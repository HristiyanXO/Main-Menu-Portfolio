...
//             {
//                 var targetRotation = (Mathf.Atan2(inputDir.x, inputDir.y) * Mathf.Rad2Deg + _cam.transform.eulerAngles.y);
//                 transform.eulerAngles = Vector3.up * Mathf.SmoothDampAngle(transform.eulerAngles.y, targetRotation, ref rotationVelocityTime, RotationSmoothTime);

//             }
//             bool running = input.magnitude > 0.9f;
...
//             nameText.text = movementSpeed.ToString();
//     }
...
//     void ResetPlayer()
//     {
//         Debug.Log(string.Format("Resetting player to: {0}", LastKnownPosition));
